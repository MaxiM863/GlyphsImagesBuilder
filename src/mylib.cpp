...
bool GIB::createPlanes(unsigned int startChar, unsigned int endChar, int panelWidth, int targetPixelHeight, const char* outSpacingGlyphsFilename)
{
...
void GIB::getGlyphAscentAndHeight(unsigned char* bmp, int width, int height, int& asc, int& desc)
{
...
bool GIB::loadFontFile(const char* filename)
{
    try {
...
unsigned char* GIB::cutGlyphRemoveSides(unsigned char* bmp, int width, int height)
{
...
unsigned char GIB::getPixel(unsigned char* bmp, int x, int y, int width, int height)
{
...
unsigned char* GIB::getSubImage(unsigned char* bmp, int width, int height, int destPosX, int destPosY, int destWidth, int destHeight)
{
...
bool GIB::drawSubImage(unsigned char* bmp, unsigned char* subImage, int width, int height, int destPosX, int destPosY, int destWidth, int destHeight)
{
